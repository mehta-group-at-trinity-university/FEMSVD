...
!     >     dd*((1-exp(-a*(r13-r0)))**(2.0d0)) - dd +
!     >     dd*((1-exp(-a*(r34-r0)))**(2.0d0)) - dd +
!     >     dd*((1-exp(-a*(r23-r0)))**(2.0d0)) - dd + 
!     >     dd*((1-exp(-a*(r24-r0)))**(2.0d0)) - dd + 
!     >     dd*((1-exp(-a*(r14-r0)))**(2.0d0)) - dd
